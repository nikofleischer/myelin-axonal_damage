...
scCC.noDblRE.clean$sample = factor(scCC.noDblRE.clean$sample, levels = c('EAE_IC_WT','EAE_IC_HMBP'))
scCC.noDblRE.clean$celltypesNew = scCC.noDblRE.clean$celltypesNew %>% recode(Monocytes = 'Activated DC')
